...
#define UE_PROJECT_NAME Experimentos
#define UE_TARGET_NAME ExperimentosEditor
#define UE_MODULE_NAME "Experimentos"
...
#define EXPERIMENTOS_API DLLEXPORT
