...
public:	
	...
	class UStaticMesh* Armeria = LoadObject<UStaticMesh>(nullptr, TEXT("StaticMesh'/Game/Mallas/0f1a3d0cc128_Fortaleza_militar__.0f1a3d0cc128_Fortaleza_militar__'"));
