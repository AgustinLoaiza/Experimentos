...
AExperimentosProjectile::AExperimentosProjectile() 
{
	...
	ProjectileMesh->OnComponentHit.AddDynamic(this, &AExperimentosProjectile::OnHit);		// set up a notification for when this component hits something
...
void AExperimentosProjectile::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
