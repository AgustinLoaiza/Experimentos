...
UComponenteMedico::UComponenteMedico()
{
...
// Called every frame
void UComponenteMedico::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
