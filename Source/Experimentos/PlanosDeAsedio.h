...
public:
	...
	virtual void SetSurtidor(FString Surtidor) = 0;  
	virtual void SetMotor(FString Motor) = 0;    
	virtual void SetMunicion(FString Municion) = 0; 
	virtual void SetCentroMedico(FString CentroMedico) = 0;
	virtual void SetComponenteChino(FString ComponenteChino) = 0;
